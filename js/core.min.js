...
* Progress bar
* */
!function(t){t.fn.counter=function(n){function e(t,a,u){var i=parseInt(t.html(),10)+a;i>=u?(t.html(Math.round(u)),n.callback()):(t.html(Math.round(i)),setTimeout(function(){e(t,a,u)},n.step))}var a={start:0,end:10,time:10,step:1e3,callback:function(){}},n=t.extend(a,n),u=t(this);t(this).html(Math.round(n.start));var i=(n.end-n.start)/(1e3/n.step*n.time);setTimeout(function(){e(u,i,n.end)},n.step)}}(jQuery);
/**
